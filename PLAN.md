...
not met. **8 of 9 met as of 2026-08-22. The one outstanding is coverage itself.**
...
| 4. | A monitored correction channel, a suppression lever behind it, and a published aggregate withheld count | **met.** Rehearsed both ways against a live row on 2026-08-22. One recorded deviation: the automatic route is a **public** issue carrying no reason, because the private advisory form would have added friction that matters more than the disclosure it prevents, and a public request makes the withheld count auditable. Private routes exist, human-reviewed | 4 |
